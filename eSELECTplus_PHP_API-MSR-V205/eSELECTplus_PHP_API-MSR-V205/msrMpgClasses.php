...
class msrMpgGlobals
{
	...
	var $Globals=array(
					  ...
					  'API_VERSION'  =>'MpgApi Version 2.0512(L23php)',
					  'CLIENT_TIMEOUT' => '60'
					 );

	 function msrMpgGlobals()
	 {
		  // default
	 }
...
}//end class msrMpgGlobals



###################### msrMpgHttpsPost #########################################

class msrMpgHttpsPost
{
 ...
 var $mpgResponse;
	...
	function msrMpgHttpsPost($storeid,$apitoken,$mpgRequestOBJ)
	{

		$this->store_id=$storeid;
		$this->api_token= $apitoken;
		$this->msrMpgRequest=$mpgRequestOBJ;
		...
		$this->msrMpgResponse=new msrMpgResponse($response);
	}
	...
	{
		return $this->msrMpgResponse;
	}

	function toXML( )
	{
		$req=$this->msrMpgRequest ;
...
class msrMpgResponse
{
	...
	function msrMpgResponse($xmlString)
	{
...
class msrMpgRequest{
	...
	var $txnTypes =array(
					  ...
					  'track2_purchase' => array('order_id','cust_id','amount','pan','expdate','track2','pos_code'),
					  'track2_preauth' => array('order_id','cust_id','amount','pan','expdate','track2','pos_code'),
					  'track2_ind_refund' => array('order_id','cust_id','amount','pan','expdate','track2','pos_code'),
					  'track2_purchasecorrection' => array('order_id','txn_number'),
					  'track2_completion' => array('order_id','comp_amount','txn_number'),
					  'track2_refund' => array('order_id','amount','txn_number'),
					);
	var $txnArray;

	function msrMpgRequest($txn)
	{
...
class msrMpgCustInfo
{
	...
	function msrMpgCustInfo($custinfo=0,$billing=0,$shipping=0,$items=0)
	{
		if($custinfo)
		{
...
class msrMpgTransaction
{

	var $txn;
	var $custInfo = null;

	function msrMpgTransaction($txn)
	{
		$this->txn=$txn;
	}
